...
export default function Home() {
  ...
  return (
    <div className="flex h-full ">
      ...
      >
        <div className="mx-2 mt-4 mb-20 border-4 border-black ">
          ...
          <button className="" onClick={() => toggleTab(4)}>
...
const SideBarIcon = ({ icon, text }) => (
  <div className="flex flex-col items-center my-6 hover:bg-cyan-700 hover:rounded-md">
